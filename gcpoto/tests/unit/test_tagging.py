...
def test_pubsub_topic_create_with_tags(
    mock_google_client,
    ...
    topic = service.create_topic(topic_name="test-topic", tags=tags)
...
def test_pubsub_subscription_create_with_tags(
    mock_google_client,
    mock_publisher_client,
    mock_subscriber_client,
    ...
    subscription = service.create_subscription(
        subscription_name="test-subscription", topic_name="test-topic", tags=tags
    )
...
def test_tags_with_labels(
    mock_google_client, mock_publisher_client, mock_subscriber_client
):
