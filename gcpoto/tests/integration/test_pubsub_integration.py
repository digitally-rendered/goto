...
@pytest.fixture(scope="module")
def test_deadletter_topic(
    pubsub_service: PubSubService,
    test_deadletter_topic_name: str,
    common_tags: Dict[str, str],
    request,
) -> PubSubTopic:
...
@pytest.fixture(scope="module")
def test_deadletter_subscription(
    pubsub_service: PubSubService,
    ...
    def cleanup():
        try:
            ...
            print(
                f"Cleaned up test dead letter subscription: {test_deadletter_subscription_name}"
            )
        except Exception as e:
...
class TestPubSubIntegration:
    ...
    def test_create_get_topic_with_tags(
        self,
        pubsub_service: PubSubService,
        test_topic: PubSubTopic,
        test_topic_name: str,
    ...
    def test_create_get_subscription_with_tags(
        self,
        pubsub_service: PubSubService,
    ...
    def test_publish_and_pull_messages(
        self,
        pubsub_service: PubSubService,
        test_topic_name: str,
        test_subscription_name: str,
        ...
        for i in range(msg_count):
            ...
            message_id = pubsub_service.publish_message(
                topic_name=test_topic_name, data=msg_data, attributes=attributes
            )
        ...
        pulled_messages = pubsub_service.pull_messages(
            subscription_name=test_subscription_name, max_messages=msg_count
        )
        ...
        if ack_ids:
            success = pubsub_service.acknowledge_messages(
                subscription_name=test_subscription_name, ack_ids=ack_ids
            )
            assert success

    def test_subscription_with_dead_letter(
        self,
        pubsub_service: PubSubService,
        test_topic: PubSubTopic,
        test_deadletter_topic: PubSubTopic,
        ...
        try:
            ...
            assert dl_sub.dead_letter_policy.dead_letter_topic.endswith(
                test_deadletter_topic.name
            )
            ...
            assert retrieved_sub.dead_letter_policy.dead_letter_topic.endswith(
                test_deadletter_topic.name
            )
    ...
    def test_subscription_with_filter(
        self,
        pubsub_service: PubSubService,
        test_topic: PubSubTopic,
        common_tags: Dict[str, str],
        ...
        try:
            ...
            messages = pubsub_service.pull_messages(
                subscription_name=filter_sub_name, max_messages=10
            )
            ...
            if messages:
                for msg in messages:
                    ...
                    pubsub_service.acknowledge_messages(
                        subscription_name=filter_sub_name, ack_ids=[msg.get("ackId")]
                    )
    ...
    def test_list_subscriptions_for_topic(
        self,
        pubsub_service: PubSubService,
        test_topic: PubSubTopic,
        test_subscription: PubSubSubscription,
