...
class StorageService(GCPService[StorageBucket]):
    ...
    def list_objects(self, bucket_name: str, prefix: Optional[str] = None, **kwargs) -> List[StorageObject]:
    ...
    def create_bucket(self, bucket_name: str, location: str = 'us', storage_class: str = 'STANDARD', 
                      labels: Optional[Dict[str, str]] = None, tags: Optional[Dict[str, str]] = None, 
                      **kwargs) -> StorageBucket:
    ...
    def upload(self, bucket_name: str, source_file: Optional[str] = None, file_path: Optional[str] = None,
              destination_blob_name: Optional[str] = None, object_name: Optional[str] = None,
              content_type: Optional[str] = None, metadata: Optional[Dict[str, str]] = None,
              tags: Optional[Dict[str, str]] = None, **kwargs) -> StorageObject:
    ...
    def download(self, bucket_name: str, object_name: str, destination_file: str, **kwargs) -> None:
    ...
    def delete_bucket(self, bucket_name: str, **kwargs) -> None:
        ...
        if objects:
            print(f"Warning: Bucket {bucket_name} is not empty. Deleting {len(objects)} objects first.")
            for obj in objects:
    ...
    def delete_object(self, bucket_name: str, object_name: str, **kwargs) -> None:
        ...
        """
        try:
            request = self.service.objects().delete(bucket=bucket_name, object=object_name, **kwargs)
            request.execute()
        except Exception as e:
            # Log the error but don't raise it (makes cleanup more robust)
            print(f"Warning: Failed to delete object {object_name} from bucket {bucket_name}: {e}")
    ...
    def download_object(self, bucket_name: str, object_name: str, 
                       destination: Optional[Union[str, BinaryIO]] = None, **kwargs) -> Union[bytes, str]:
    ...
    def upload_object(self, bucket_name: str, object_name: str, 
                     ...
                     content_type: Optional[str] = None, **kwargs) -> StorageObject:
        ...
        if isinstance(content, bytes):
            media = MediaInMemoryUpload(content, mimetype=content_type or 'application/octet-stream')
            ...
            media = MediaInMemoryUpload(content_bytes, 
